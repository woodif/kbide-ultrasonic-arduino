...
# ตัวอย่างการต่อวงจรร่วมกับบอร์ด Arduino nano
...
![image](https://github.com/woodif/kbide-ultrasonic-arduino/blob/master/static/ultrasonic_setupBlock.JPG)

บล็อกอ่านข้อมูลจากเซ็นเซอร์ Ultrasonic
![image](https://github.com/woodif/kbide-ultrasonic-arduino/blob/master/static/ultrasonic_getDataBlock.JPG)

ตัวอย่างบล็อกแสดงผลผ่านทาง Serial monitor
![image](https://github.com/woodif/kbide-ultrasonic-arduino/blob/master/static/serial_monitor.JPG)

ตัวอย่างบล็อกแสดงผลผ่านทาง Serial graph
![image](https://github.com/woodif/kbide-ultrasonic-arduino/blob/master/static/serial_graph.JPG)
